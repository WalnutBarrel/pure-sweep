          ...
          <div className="border-t border-border pt-6 flex flex-col sm:flex-row gap-3">
            {whatsappUrl && (
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20ba56] text-white px-6 py-3 text-xs uppercase tracking-widest font-semibold transition-colors duration-300"
              >
                <svg className="w-4 h-4 fill-current shrink-0" viewBox="0 0 24 24">
                  <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.513 2.262 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.455L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.37 9.864-9.799.002-2.63-1.023-5.101-2.885-6.963C16.588 1.981 14.115.95 11.48.95c-5.447 0-9.873 4.372-9.877 9.802-.001 1.77.462 3.5 1.342 5.025l-.986 3.6 3.693-.968zm11.233-5.263c-.3-.149-1.771-.864-2.046-.964-.275-.1-.475-.149-.675.149-.2.299-.775.964-.95 1.163-.175.199-.35.224-.65.075-1.125-.562-1.926-1.002-2.696-2.317-.2-.349.2-.324.575-1.073.075-.149.038-.274-.019-.398-.057-.124-.475-1.144-.65-1.562-.175-.421-.349-.361-.475-.361-.125-.005-.275-.005-.425-.005s-.399.056-.607.274c-.208.219-.796.772-.796 1.88s.812 2.175.925 2.324c.112.15 1.599 2.441 3.874 3.419 1.13.487 1.774.656 2.385.748.675.101 1.288.072 1.772.001.538-.079 1.771-.716 2.021-1.408.25-.693.25-1.288.175-1.408-.075-.12-.275-.219-.575-.369z"/>
                </svg>
