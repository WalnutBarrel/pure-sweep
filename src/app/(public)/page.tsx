  ...
  return (
    <>
      ...
      <div className="space-y-24 pb-20 overflow-x-hidden">
        ...
        {/* 3. Trust Strip */}
        <FadeIn delay={0.1}>
          <section className="border-b border-border bg-stone-50 py-12 relative overflow-hidden">
            <div className="noise-overlay" />
            <Container className="relative z-10">
              <div className="flex flex-wrap lg:flex-nowrap items-start lg:items-center justify-between gap-10 md:gap-8 opacity-90 mix-blend-multiply">
                <div className="flex items-center gap-4 w-full md:w-auto">
                  <ShieldCheck className="h-5 w-5 text-accent shrink-0" />
                  <div>
                    <h4 className="text-[11px] font-bold uppercase tracking-[0.1em] text-primary">Fully Vetted Cleaners</h4>
                    <p className="text-xs text-stone-500 mt-0.5">Police checked & security screened.</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 w-full md:w-auto lg:pl-10 lg:border-l lg:border-border/60">
                  <CheckCircle2 className="h-5 w-5 text-accent shrink-0" />
                  <div>
                    <h4 className="text-[11px] font-bold uppercase tracking-[0.1em] text-primary">Auckland Owned</h4>
                    <p className="text-xs text-stone-500 mt-0.5">Local care, serving central suburbs.</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 w-full md:w-auto lg:pl-10 lg:border-l lg:border-border/60">
                  <Zap className="h-5 w-5 text-accent shrink-0" />
                  <div>
                    <h4 className="text-[11px] font-bold uppercase tracking-[0.1em] text-primary">Clear Flat Pricing</h4>
                    <p className="text-xs text-stone-500 mt-0.5">No hidden fees, GST displayed.</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 w-full md:w-auto lg:pl-10 lg:border-l lg:border-border/60">
